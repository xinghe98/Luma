...
func NewRouter(params RouterParams) (http.Handler, error) {
	...
	protected.GET("/media/:id/stream/source", params.Stream.Source)
	protected.HEAD("/media/:id/stream/source", params.Stream.Source)
	protected.GET("/media/:id/stream/faststart/:fingerprint", params.Stream.Faststart)
	protected.HEAD("/media/:id/stream/faststart/:fingerprint", params.Stream.Faststart)
